...
#ifndef CPP_EVS_SAMPLEDRIVER_AIDL_INCLUDE_EVSV4LCAMERAZEROCOPY_H
#define CPP_EVS_SAMPLEDRIVER_AIDL_INCLUDE_EVSV4LCAMERAZEROCOPY_H
...
class EvsV4lCameraZeroCopy : public ::aidl::android::hardware::automotive::evs::BnEvsCamera {
public:
    ...
    static std::shared_ptr<EvsV4lCameraZeroCopy> Create(const char* deviceName);
    static std::shared_ptr<EvsV4lCameraZeroCopy> Create(const char* deviceName,
                                                std::unique_ptr<ConfigManager::CameraInfo>& camInfo,
                                                const aidlevs::Stream* streamCfg = nullptr);
    EvsV4lCameraZeroCopy(const EvsV4lCameraZeroCopy&) = delete;
    EvsV4lCameraZeroCopy& operator=(const EvsV4lCameraZeroCopy&) = delete;

    virtual ~EvsV4lCameraZeroCopy() override;
    void shutdown();
    ...
    // Constructors
    EvsV4lCameraZeroCopy(const char* deviceName, std::unique_ptr<ConfigManager::CameraInfo>& camInfo);
...
#endif  // CPP_EVS_SAMPLEDRIVER_AIDL_INCLUDE_EVSV4LCAMERAZEROCOPY_H
